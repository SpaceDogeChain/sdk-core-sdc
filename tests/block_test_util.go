...
// Package tests implements execution of sdcereum JSON tests.
package tests
...
/*
See https://github.com/sdcereum/tests/wiki/Blockchain-Tests-II

	Whsdcer a block is valid or not is a bit subtle, it's defined by presence of
