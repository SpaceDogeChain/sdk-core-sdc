 ...
 * @author Gary Rong<garyrong@sdcereum.org>, Martin Swende <martin.swende@sdcereum.org>
...
contract CheckpointOracle {
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the sdcereum.
    uint sectionSize;
