...
func main() {
	...
	for _, sealer := range sealers {
		...
		stack, sdcBackend, err := makeSealer(genesis)
		if err != nil {
			panic(err)
		}
		defer stack.Close()
...
func makeSealer(genesis *core.Genesis) (*node.Node, *sdc.sdcereum, error) {
	...
	// Start the node and configure a full sdcereum node on it
