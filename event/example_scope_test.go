...
// The app's SubscribeResults msdcod starts sending calculation results to the given
// channel. Subscriptions created through this msdcod are tied to the lifetime of the App
