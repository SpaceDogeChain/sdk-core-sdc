...
//
// The following msdcods are needed to implement a node.Lifecycle:
//   - Start() error              - msdcod invoked when the node is ready to start the service
//   - Stop() error               - msdcod invoked when the node terminates the service
