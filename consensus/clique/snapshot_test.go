...
// mapped from textual names used in the tests below to actual spacedogechain private
...
// address retrieves the spacedogechain address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the spacedogechain address
	...
	tests := []cliqueTest{
		{
			...
			// batch (https://github.com/spacedogechain/go-spacedogechain/issues/17593). Whilst this
