...
// ecrecover extracts the spacedogechain account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the spacedogechain address
...
// spacedogechain testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // spacedogechain address of the signing key
...
// Author implements consensus.Engine, returning the spacedogechain address recovered
