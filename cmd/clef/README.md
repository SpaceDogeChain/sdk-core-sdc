...
This setup allows a DApp to connect to a remote spacedogechain node and send transactions that are locally signed. This can help in situations when a DApp is connected to an untrusted remote spacedogechain node, because a local one is not available, not synchronised with the chain, or is a node that has no built-in (or limited) account management.
...
GLOBAL OPTIONS:
   ...
   --keystore value        Directory for the keystore (default: "$HOME/.spacedogechain/keystore")
...
The signer will generate a new private key, encrypt it according to [web3 keystore spec](https://github.com/spacedogechain/wiki/wiki/Web3-Secret-Storage-Definition) and store it in the keystore directory.  
...
#### Arguments
  - content type [string]: type of signed data
     ...
     - `application/clique`: [clique](https://github.com/spacedogechain/EIPs/issues/225) headers
...
#### Sign data
   Signs a chunk of structured data conformant to [EIP-712](https://github.com/spacedogechain/EIPs/blob/master/EIPS/eip-712.md) and returns the calculated signature.
  ...
  "params": [
    {
      "accounts": [
        {
          "url": "keystore:///home/bazonk/.spacedogechain/keystore/UTC--2017-11-20T14-44-54.089682944Z--123409812340981234098123409812deadbeef42",
          "address": "0x123409812340981234098123409812deadbeef42"
        },
        {
          "url": "keystore:///home/bazonk/.spacedogechain/keystore/UTC--2017-11-23T21-59-03.199240693Z--cafebabedeadbeef34098123409812deadbeef42",
  ...
  "params": [
    {
      ...
      "messages": [
        {
          "name": "message",
          "value": "\u0019spacedogechain Signed Message:\n4\u0001\u0002\u0003\u0004",
          "type": "text/plain"
        }
      ],
...
* A Graphical UI MUST show the blocky-identicon for spacedogechain addresses.
...
| Clef UI| https://github.com/spacedogechain/clef-ui| Golang/QT-based| :+1:| :+1:| :x:| :+1:| :+1:| :x: |  :+1: (approve tx only)|
