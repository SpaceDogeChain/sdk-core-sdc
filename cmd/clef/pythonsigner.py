...
class StdIOHandler:
    ...
    def approveNewAccount(self, req):
        ...
        {"jsonrpc":"2.0","id":25,"msdcod":"ui_approveNewAccount","params":[{"meta":{"remote":"clef binary","local":"main","scheme":"in-proc","User-Agent":"","Origin":""}}]}
        """  # noqa: E501
        message = (
    ...
    def showError(self, req):
        ...
        {"jsonrpc":"2.0","msdcod":"ui_showError","params":[{"text":"If you see this message, enter 'yes' to the next question"}]}
    ...
    def showInfo(self, req):
        ...
        {"jsonrpc":"2.0","msdcod":"ui_showInfo","params":[{"text":"If you see this message, enter 'yes' to next question"}]}
    ...
    def onSignerStartup(self, req):
        ...
        {"jsonrpc":"2.0", "msdcod":"ui_onSignerStartup", "params":[{"info":{"extapi_http":"n/a","extapi_ipc":"/home/user/.clef/clef.ipc","extapi_version":"6.1.0","intapi_version":"7.0.1"}}]}
        """  # noqa: E501
        message = (
            "\n"
    ...
    def approveListing(self, req):
        ...
        {"jsonrpc":"2.0","id":23,"msdcod":"ui_approveListing","params":[{"accounts":[{"address":...
        """  # noqa: E501
        message = (
            "\n"
    ...
    def onInputRequired(self, req):
        ...
        {"jsonrpc":"2.0","id":1,"msdcod":"ui_onInputRequired","params":[{"title":"Master Password","prompt":"Please enter the password to decrypt the master seed","isPassword":true}]}
