...
var (
	walletCommand = &cli.Command{
		Name:      "wallet",
		Usage:     "Manage spacedogechain presale wallets",
		ArgsUsage: "",
		Description: `
		...
		Subcommands: []*cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import spacedogechain presale wallet",
				ArgsUsage: "<keyFile>",
				Action:    importWallet,
				Flags: []cli.Flag{
					utils.DataDirFlag,
...
between spacedogechain nodes by simply copying.
...
Note:
As you can directly copy your encrypted accounts to another spacedogechain instance,
