...
import (
	...
	"github.com/spacedogechain/go-spacedogechain/accounts/external"
...
// makeFullNode loads geth configuration and creates the spacedogechain backend.
func makeFullNode(ctx *cli.Context) (*node.Node, ethapi.Backend) {
	...
	// Add the spacedogechain Stats daemon if requested.
	if cfg.Ethstats.URL != "" {
