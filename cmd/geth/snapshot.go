...
import (
	...
	"github.com/spacedogechain/go-spacedogechain/core/state/pruner"
	"github.com/spacedogechain/go-spacedogechain/core/state/snapshot"
...
var (
	snapshotCommand = &cli.Command{
		...
		Subcommands: []*cli.Command{
			{
				Name:      "prune-state",
				Usage:     "Prune stale spacedogechain state data based on the snapshot",
				ArgsUsage: "<root>",
				Action:    pruneState,
