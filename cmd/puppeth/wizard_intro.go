...
// setting up a new or managing an existing spacedogechain private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your spacedogechain private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new spacedogechain network down to  |")
	...
	log.Info("Administering spacedogechain network", "name", w.network)
