...
type wizard struct {
	...
	services map[string][]string   // spacedogechain services known to be running on servers
...
// it to an spacedogechain address.
...
// converts it to an spacedogechain address. If an empty line is entered, the default
// value is returned.
