...
// bootnode runs a bootstrap node for the spacedogechain Discovery Protocol.
package main
...
import (
	...
	"github.com/spacedogechain/go-spacedogechain/p2p/discover"
...
func main() {
	...
	if natm != nil {
		if !realaddr.IP.IsLoopback() {
			go nat.Map(natm, nil, "udp", realaddr.Port, realaddr.Port, "spacedogechain discovery")
		}
