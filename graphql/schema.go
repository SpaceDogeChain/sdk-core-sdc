...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte sdcereum address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an sdcereum account at a particular block.
    type Account {
    ...
    # Transaction is an sdcereum transaction.
    type Transaction {
    ...
    type Block {
        ...
        # Account fetches an sdcereum account at the current block's state.
    ...
    type Pending {
      ...
      transactions: [Transaction!]
      # Account fetches an sdcereum account for the pending state.
      account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an sdcereum block by number or by hash. If neither is
