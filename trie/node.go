...
type nodeFlag struct {
	...
	dirty bool     // whsdcer the node has changes that must be written to the database
}
...
// scenarios with low performance requirements and hard to determine whsdcer the
