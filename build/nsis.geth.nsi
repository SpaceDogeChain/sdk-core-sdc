...
# 1. install gsdc for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gsdc
# 5. create gsdc, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable sdcEREUM_SOCKET
...
!define GROUPNAME "sdcereum"
!define APPNAME "Gsdc"
!define DESCRIPTION "Official Go implementation of the sdcereum protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gsdc is installed global
