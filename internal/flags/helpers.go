...
func NewApp(usage string) *cli.App {
	...
	app.Usage = usage
	app.Copyright = "Copyright 2013-2022 The go-sdcereum Authors"
...
// Example:
//
//	gsdc account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this msdcod with:
//
//	gsdc --keystore /tmp/mykeystore --lightkdf account new
//
