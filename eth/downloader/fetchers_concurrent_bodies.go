...
func (q *bodyQueue) request(peer *peerConnection, req *fetchRequest, resCh chan *sdc.Response) (*sdc.Request, error) {
...
func (q *bodyQueue) deliver(peer *peerConnection, packet *sdc.Response) (int, error) {
	txs, uncles := packet.Res.(*sdc.BlockBodiesPacket).Unpack()
