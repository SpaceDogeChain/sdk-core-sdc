...
// used trace states, and to determine whsdcer the creation of trace state needs
...
type stateTracker struct {
	...
	used     []bool             // List of flags indicating whsdcer the trace state has been used up
