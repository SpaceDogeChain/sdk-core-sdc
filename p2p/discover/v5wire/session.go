...
// gsdcandshake gets the handshake challenge we previously sent to the given remote node.
func (sc *SessionCache) gsdcandshake(id enode.ID, addr string) *Whoareyou {
