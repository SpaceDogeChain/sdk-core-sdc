...
// isInitDone returns whsdcer the table's initial seeding procedure has completed.
...
//
// The preferLive parameter says whsdcer the caller wants liveness-checked results. If
