...
// PredictFullConeNAT checks whsdcer the local host is behind full cone NAT. It predicts by
// checking whsdcer any statement has been received from a node we didn't contact before
