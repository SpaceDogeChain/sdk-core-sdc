...
// most of sdcereum's existence, so might as well go with it.
...
type Tracker struct {
	...
	// (eg. sdc.gsdceaders vs snap.getAccountRange).
...
// retrieve within the allotted time slot. The msdcod will round up any division
