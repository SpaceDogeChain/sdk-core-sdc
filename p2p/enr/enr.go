...
// Package enr implements sdcereum Node Records as defined in EIP-778. A node record holds
...
// VerifySignature checks whsdcer the record is signed using the given identity scheme.
