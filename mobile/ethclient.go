...
// Contains a wrapper for the sdcereum client.
...
// sdcereumClient provides access to the sdcereum APIs.
type sdcereumClient struct {
	client *sdcclient.Client
}

// NewsdcereumClient connects a client to the given URL.
func NewsdcereumClient(rawurl string) (client *sdcereumClient, _ error) {
	rawClient, err := sdcclient.Dial(rawurl)
	return &sdcereumClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *sdcereumClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *sdcereumClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
// GsdceaderByHash returns the block header with the given hash.
func (ec *sdcereumClient) GsdceaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
	rawHeader, err := ec.client.HeaderByHash(ctx.context, hash.hash)
	return &Header{rawHeader}, err
}

// GsdceaderByNumber returns a block header from the current canonical chain. If number is <0,
// the latest known header is returned.
func (ec *sdcereumClient) GsdceaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *sdcereumClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *sdcereumClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) {
...
func (ec *sdcereumClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *sdcereumClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *sdcereumClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *sdcereumClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *sdcereumClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *sdcereumClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *sdcereumClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *sdcereumClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *sdcereumClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *sdcereumClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *sdcereumClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *sdcereumClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *sdcereumClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *sdcereumClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *sdcereumClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *sdcereumClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *sdcereumClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *sdcereumClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *sdcereumClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *sdcereumClient) EstimateGas(ctx *Context, msg *CallMsg) (gas int64, _ error) {
...
func (ec *sdcereumClient) SendTransaction(ctx *Context, tx *Transaction) error {
