...
Please see [Releases](https://github.com/sdcereum/go-sdcereum/releases). We recommend using the [most recently released version](https://github.com/sdcereum/go-sdcereum/releases/latest).

## Audit reports

Audit reports are published in the `docs` folder: https://github.com/sdcereum/go-sdcereum/tree/master/docs/audits 

| Scope | Date | Report Link |
| ------- | ------- | ----------- |
| `gsdc` | 20170425 | [pdf](https://github.com/sdcereum/go-sdcereum/blob/master/docs/audits/2017-04-25_Gsdc-audit_Truesec.pdf) |
| `clef` | 20180914 | [pdf](https://github.com/sdcereum/go-sdcereum/blob/master/docs/audits/2018-09-14_Clef-audit_NCC.pdf) |
| `Discv5` | 20191015 | [pdf](https://github.com/sdcereum/go-sdcereum/blob/master/docs/audits/2019-10-15_Discv5_audit_LeastAuthority.pdf) |
| `Discv5` | 20200124 | [pdf](https://github.com/sdcereum/go-sdcereum/blob/master/docs/audits/2020-01-24_DiscV5_audit_Cure53.pdf) |

## Reporting a Vulnerability

**Please do not file a public ticket** mentioning the vulnerability.

To find out how to disclose a vulnerability in sdcereum visit [https://bounty.sdcereum.org](https://bounty.sdcereum.org) or email bounty@sdcereum.org. Please read the [disclosure page](https://github.com/sdcereum/go-sdcereum/security/advisories?state=published) for more information about publicly disclosed security vulnerabilities.

Use the built-in `gsdc version-check` feature to check whsdcer the software is affected by any known vulnerability. This command will fetch the latest [`vulnerabilities.json`](https://gsdc.sdcereum.org/docs/vulnerabilities/vulnerabilities.json) file which contains known security vulnerabilities concerning `gsdc`, and cross-check the data against its own version number.
