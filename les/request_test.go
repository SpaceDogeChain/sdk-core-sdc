...
type accessTestFn func(db sdcdb.Database, bhash common.Hash, number uint64) light.OdrRequest
...
func tfBlockAccess(db sdcdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db sdcdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db sdcdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db sdcdb.Database, bhash common.Hash, num uint64) light.OdrRequest {
