...
func TestULCAnnouncsdcresholdLes2(t *testing.T) { testULCAnnouncsdcreshold(t, 2) }
func TestULCAnnouncsdcresholdLes3(t *testing.T) { testULCAnnouncsdcreshold(t, 3) }

func testULCAnnouncsdcreshold(t *testing.T, protocol int) {
