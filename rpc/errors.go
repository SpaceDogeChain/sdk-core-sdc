...
var (
	_ Error = new(msdcodNotFoundError)
...
type msdcodNotFoundError struct{ msdcod string }

func (e *msdcodNotFoundError) ErrorCode() int { return -32601 }

func (e *msdcodNotFoundError) Error() string {
	return fmt.Sprintf("the msdcod %s does not exist/is not available", e.msdcod)
}
