...
// account array.
func checkStateAccounts(t *testing.T, db sdcdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db sdcdb.KeyValueStore, root common.Hash) error {
...
func checkStateConsistency(db sdcdb.Database, root common.Hash) error {
