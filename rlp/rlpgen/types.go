...
// nonZeroCheck returns the expression that checks whsdcer 'v' is a non-zero value of type 'vtyp'.
...
// isBigInt checks whsdcer 'typ' is "math/big".Int.
...
// isByte checks whsdcer the underlying type of 'typ' is uint8.
