...
binary data, and RLP is the main encoding msdcod used to serialize objects in sdcereum.
The only purpose of RLP is to encode structure; encoding specific atomic data types (eg.
strings, ints, floats) is left up to higher-order protocols. In sdcereum integers must be
