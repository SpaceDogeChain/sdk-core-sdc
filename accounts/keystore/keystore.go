...
// See https://github.com/sdcereum/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
type KeyStore struct {
	...
	updating    bool                    // Whsdcer the event notification loop is running
...
// isUpdating returns whsdcer the event notification loop is running.
// This msdcod is mainly meant for tests.
